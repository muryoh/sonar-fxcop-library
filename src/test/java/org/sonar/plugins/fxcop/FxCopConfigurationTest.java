...
public class FxCopConfigurationTest {
  ...
  @Test
  public void test() {
    FxCopConfiguration fxCopConf = new FxCopConfiguration("cs", "cs-fxcop", "fooAssemblyKey", "fooDirectoryPropertyKey", "fooFxCopCmdPathKey", "fooTimeoutKey", "fooAspnetKey");
    ...
    fxCopConf = new FxCopConfiguration("vbnet", "vbnet-fxcop", "barAssemblyKey", "barDirectoryPropertyKey", "barFxCopCmdPathKey", "barTimeoutKey", "barAspnetKey");
